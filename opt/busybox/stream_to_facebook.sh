...
ffmpeg -f x11grab -s 720x480 \
-i :0 \
-i /opt/busy/sounds/cafe_noise.mp3 \
-acodec libfdk_aac \
-ar 44100 \
-b:a 128k \
-pix_fmt yuv420p \
...
-r 15 \
-qscale 1 \
-f flv "rtmp://live-api-s.facebook.com:80/rtmp/1090678404439088?s_ps=1&s_sw=0&s_vt=api-s&a=Abya9SHT4dW-E4Aa"
